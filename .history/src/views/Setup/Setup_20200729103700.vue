  ...
  mounted() {
    ...
    this.$api
      ...
      .then((res) => {
        ...
        this.msg.push(res.userInfo.year, res.userInfo.month, res.userInfo.day);
        console.log(this.arr, "用户信息");
      })

      .catch();

    console.log(this.msg, "msgf");
    let time = new Date();
    console.log(time);
    this.currentDate = new Date(dayjs(this.msg).format("YYYY MM DD"));
