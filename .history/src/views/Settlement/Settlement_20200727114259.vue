...
export default {
  ...
  mounted() {
    localStorage.setItem('arr',JSON.stringify(this.$route.query.arr))
    this.arr = this.$route.query.arr; //获取id
    console.log(this.arr, "arr");
    console.log(this.$route.query, "this.$route.query");

    this.num = this.arr.value;
    this.present_price = this.arr.id.present_price;
    this.image = this.arr.id.image;
