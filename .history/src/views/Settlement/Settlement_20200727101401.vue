...
export default {
  ...
  methods: {
    //返回到详情页
    ret() {
      console.log(this.id,"数组id");
      this.$router.push({ //24afea564e5248b5a2bc59da95f09911
                          //5f1542d2f582ee1d0492fa5c
        path: "/Details", //5f1542d2f582ee1d0492fa5c
        query: {
          id: this.id,
        },
      });
