  ...
  mounted() {
    ...
    this.$api
      ...
      .then((res) => {
        ...
        this.tel1 = "收货人:" + res.defaultAdd.name;
        this.tiaddress1tle1 = "收货人:" + res.defaultAdd.name;
    ...
    if (this.$route.query) {
      setTimeout(() => {
        this.title1 = "收货人:" + this.$route.query.info.name;
        this.tel1 = "电话:" + this.$route.query.info.tel;
        this.address1 = "地址:" + this.$route.query.info.address;
      }, 500);
    }
  },
  watch: {},
