<template>
  <div class="box">
    ...
    <div class="top">
      <div class="avatar">
        <img :src="this.arr.avatar" alt width="50px"/>
      </div>
    ...
    <div class="bottom">
      ...
      <van-cell is-link icon="eye-o" @click="showPopup">最近浏览</van-cell>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    console.log(this.$route.query, "484948");
    if(this.$route.query){this.user = this.$route.query.userinfo;
