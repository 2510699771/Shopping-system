...
export default {
  ...
  methods: {
    ...
    evaluation() {
      ...
      // this.utils.checkLogin(Recent_browse)
      // this.utils.checkLogin(allorder)
      // this.utils.checkLogin(set)
      // this.utils.checkLogin(address)
      // this.utils.checkLogin(exit)
      // this.utils.checkLogin(collection)
    },
    evaluationn() {
    ...
    //点击最近浏览跳转
Recent_browse(){
  this.utils.checkLogin1(Recent_browse)
},
    Recent_browse1() {
