<template>
  <div>
    ...
    <div v-if="this.arr.length===0 && this.user!=''" class="shoppic">
      <img src="../../assets/shop.png" alt />
      <van-button round plain type="info" style="width:150px;margin-top:20px" @click="shopping">去购物</van-button>
    </div>
    <div v-if="this.arr.length>0 && this.user!=''">
      <div>
        <div class="topall">
          <div>
      ...
      <div v-for="(item,index) in arr" :key="index" class="box">
        <div class="left">
          <van-checkbox v-model="itemcheck" @click="chose(item,index)" @change="changeone"></van-checkbox>
        </div>
        <div>
    ...
    <div v-if="this.user===''">
      ...
      <div class="log">
        <van-button round @click="login">点击登录</van-button>
      </div>
    </div>
  </div>
</template>
