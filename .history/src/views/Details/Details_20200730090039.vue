      ...
      <van-tab style="margin-bottom:50px">
        ...
        <div>
          <div v-for="(item1,index1) in this.msg" :key="index1" style="margin-top:20px">
            <div class="msgtop">
              <div>
                <div v-if="item1.anonymous === true" style="margin:0 0 0 10px"><img :src="item1.comment_avatar" alt width="40px" class="imf" /></div>
                <div v-if="item1.anonymous === false" style="margin:0 0 0 10px"><img :src="item1.user[0].avatar" alt width="40px" class="imf" /></div>
