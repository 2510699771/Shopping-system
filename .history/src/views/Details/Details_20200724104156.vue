<template>
  <div>
    ...
    <van-goods-action style="margin-top:100px">
      ...
      <van-goods-action-icon v-if="this.num>=1" icon="cart-o" text="购物车" @click="gotoshop"  :badge="num"/>
      <van-goods-action-icon v-if="this.num===0"icon="cart-o" text="购物车" @click="gotoshop"  :badge="num"/>
