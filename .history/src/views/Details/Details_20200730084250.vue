        ...
        <div>
          <div v-for="(item1,index1) in this.msg" :key="index1">
            <div>
              ...
              <div>
                <div v-if="item1.nonymous === true">{{item1.comment_nickname}}</div>
                <div v-if="item1.nonymous === false">{{item1.user[0].nickname}}</div>
                <div>
                  <van-rate v-model="item1.rate" />
                </div>
              </div>
              <div>{{item1.comment_time}}</div>
            </div>
            <div>
