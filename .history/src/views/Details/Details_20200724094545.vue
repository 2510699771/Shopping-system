  ...
  <div>
    ...
    >
      <div class="buytop">
        ...
        <div>
          <div>{{this.arr.name}}</div>
          <div>¥ {{this.arr.present_price}}</div>
        </div>
      </div>
      <div class="buycon">
        ...
        <div style="margin-right:20px">
          <van-stepper v-model="value" min="0" max="50" integer></van-stepper>
        </div>
      </div>
      <div style="margin-left:20px;margin-top:20px">
        <span style="color:gray;font:size:12px">剩余{{this.arr.amount}}</span>
        <span style="color:gray;font:size:12px">每人限购不知道多少盒</span>
      </div>
    </van-popup>
    <!-- 底部商品导航 -->
