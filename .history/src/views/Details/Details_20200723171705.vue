  ...
  <div>
    ...
    <div class="out">
      <div class="in">
        ...
        <div v-if="num===0" style="color:gray;font-size: 10px;">点击收藏:<van-icon name="like-o" /></div>
        <div v-if="num===1" style="color:gray;font-size: 10px;">取消收藏:<van-icon name="like-o" /></div>
      </div>
    </div>
