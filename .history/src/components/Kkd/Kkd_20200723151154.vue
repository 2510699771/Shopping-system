      ...
      <div class="tabsWrapper" ref="tabsWrapper">
        <div v-for="(item,index) in arr" :key="index">
          <div v-if="index===activeKey">
            <divul v-for="(item1,index1) in item.bxMallSubDto " :key="index1">
              <van-tab :title="item1.mallSubName" class="vant">
                <li v-for="(item2,index2) in dataList" :key="index2" class="box1">
                  <div class="box2">
...
export default {
  ...
  mounted() {
    ...
    this.get();
    new BScroll(this.$refs.tabsWrapper, { click: true, scrolly: true });
  },
  watch: {},
  computed: {},
};
