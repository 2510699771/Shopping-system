<template>
  <div class="box2">
    ...
    <div>
      ...
      <div v-if="goods.length===0 && $store.state.rrr===0" class="allhis" style="margin:20px 0 0 20px;display:flex">
        <div><span class="his">搜索历史</span></div>
        <div></div><van-button type="primary" @click="del" size="mini">删除历史</van-button>
